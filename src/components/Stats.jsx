...
const Stats = () => {
  return (
    <div className="my-6 bg-sky-50">
      <section className="my-8 bg-sky-50 text-gray-300">
      ...
      <section className="p-6 my-6 bg-sky-50 text-gray-800">
        <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
          <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
            <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-sky-600">
              <svg
            ...
            <div className="flex flex-col justify-center align-middle">
              ...
              <p className="capitalize">Upcomming Projects</p>
            </div>
          </div>
          <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
            <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-sky-600">
            ...
            <div className="flex flex-col justify-center align-middle">
              ...
              <p className="capitalize">Units Handovered</p>
            </div>
          </div>
          <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
            <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-sky-600">
            ...
            <div className="flex flex-col justify-center align-middle">
              ...
              <p className="capitalize">On-Going Projects</p>
            </div>
          </div>
          <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-50 dark:text-gray-800">
            <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-sky-600">
            ...
            <div className="flex flex-col justify-center align-middle">
              <p className="text-3xl font-semibold leading-none">3</p>
              <p className="capitalize">Upcomming Projects</p>
            </div>
          </div>
        </div>
